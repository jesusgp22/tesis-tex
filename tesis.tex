...
\begin{itemize}
	\item{Construimos un monitor de red con la cantidad de código minimo para planificar tareas de monitoreo periódico de acuerdo a un plan definido en la aplicacion web. El monitor escrito en python es ligero e ideal para desplegar en dispositivos de bajo costo.}
	\item{Establecimos un esquema de sincronización a costo cero entre la aplicacion web y el monitor a través del uso de las cuotas de almacenamiento en la nube y peticiones al API que Dropbox provee de forma gratuita.}
	\item{Se desarrolló una aplicacion web con una interfaz moderna y fácil de usar que se ajusta de manera fluida a distintos dispositivos.}
	\item{Un framework para integrar fácilmente nuevas pruebas y visualizaciones fue diseñado e implementado, el framework se usó para implementar cuatro pruebas:}
	\begin{itemize}
		\item{Una prueba de ping para determinar latencia y }
	\end{itemize}
\end{itemize}
