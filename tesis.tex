...
\begin{itemize}
	...
	\item{Para la aplicación web se diseñó una arquitectura a cuatro capas capaz de manejar eficientemente las distintas tareas de la aplicacion web, esta arquitectura permite escalar cada uno de sus componentes tanto como sea necesario facilitando el manejo de mayores cargas de trabajo y usuarios.}
...
La aplicacion web fue desplegada en un servidor de pruebas, la integración y prueba constante de nuevas características en este entorno de producción fue crucial en el desarrollo del \textit{workflow} de integración de pruebas, la aplicacion web está disponible en el siguiente URL: http://www.octopusmon.it/octopusmonitor. 
