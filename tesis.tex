...
TODO: agregar diagrama entidad-relacion
...
\begin{table}[H]
	...
	\begin{center}
		\begin{tabular}{r|p{2cm}p{8cm}}	
			...
			\textbf{\textit{MonitorTest}} & \multicolumn{2}{p{10cm}}{Almacena una prueba planificada para un monitor, asi como su tiempo inicial, final, su estado y parámetros.}\\
