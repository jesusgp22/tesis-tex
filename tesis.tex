...
La aplicación web "Octopus Head" hace las veces de interfaz entre el usuario final y sus monitores de red, ademas es el encargado de recolectar los datos obtenidos del monitoreo y crear poderosas visualizaciones interactivas a partir de ellos, a través de la interfaz web es posible crear monitores, agregar tentacles (enlaces a monitorear), definir y editar el plan de monitoreo, definir el horario de sincronizacion y computar cada una de las distintas visualizaciones.
