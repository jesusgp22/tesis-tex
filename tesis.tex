...
Este esquema asegura que la aplicacion web sirva como interfaz entre el usuario y los monitores, esto es especialmente útil ya que los monitores de red podrían potencialmente ser abandonados en sitios de difícil acceso, se hablará a fondo de los monitores de red en el Capítulo \ref{cap:monitor}.
